defmodule GatewayService.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :gateway_service
  ...
  def plugins do
    [
      ...
      # GatewayService.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:gateway_service, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
